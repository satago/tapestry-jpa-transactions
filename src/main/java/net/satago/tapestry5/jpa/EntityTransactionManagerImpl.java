...
public class EntityTransactionManagerImpl implements EntityTransactionManager
{
    ...
    /* (non-Javadoc)
     * @see net.satago.tapestry5.jpa.EntityTransactionManager#runInTransaction(java.lang.String, java.lang.Runnable)
     */
    ...
    /* (non-Javadoc)
     * @see net.satago.tapestry5.jpa.EntityTransactionManager#invokeInTransaction(java.lang.String, org.apache.tapestry5.ioc.Invokable)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.satago.tapestry5.jpa.EntityTransactionManager#invokeBeforeCommit(org.apache.tapestry5.ioc.Invokable, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.satago.tapestry5.jpa.EntityTransactionManager#invokeAfterCommit(org.apache.tapestry5.ioc.Invokable, java.lang.String)
     */
    @Override
