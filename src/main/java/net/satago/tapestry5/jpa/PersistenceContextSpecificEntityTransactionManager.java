...
import net.satago.tapestry5.jpa.EntityTransactionManager.VoidInvokable;
...
public class PersistenceContextSpecificEntityTransactionManager
{
    ...
    public <T> T invokeInTransaction(Invokable<T> invokable)
    {
        ...
        {
            // happens for example if you try to run a transaction in @PostCommit hook. We can only allow VoidInvokables
